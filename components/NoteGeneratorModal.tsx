...
export const NoteGeneratorModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={toggleNoteModal}>
            <div className="bg-white dark:bg-gray-900 w-full max-w-4xl h-[90vh] rounded-xl shadow-2xl flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
                {/* Header */}
